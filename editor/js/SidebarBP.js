...
{
    //initial cells
    var data = new mxCell('empty', new mxGeometry(0, 25, 100, 26), 'text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[];resizeParent=1;');
    data.vertex = true;
    data.lock = true;
